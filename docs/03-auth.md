...
**Product:** ForagePro
**Protected Routes:** /dashboard, /account, /ideas, /users, /recipes
**Onboarding:** 3 steps
...
**Steps:**
1. Step 1: Sign Up: Create a new user account
2. Step 2: Complete Profile: Add profile information, such as name and location
3. Step 3: Explore Recipes: Browse and discover wild food recipes shared by the community
