...
**Description:** Social marketplace platform connecting enthusiasts with local experts and suppliers
...
- **title:** Object with default and template
  - default: "ForagePro"
  - template: "%s | ForagePro" (for page-specific titles)

- **description:** "Forage Local, Eat Wild"

- **keywords:** Array with relevant keywords
  - "foragepro"
  - Additional relevant keywords for the product

- **authors:** [{ name: "ForagePro" }]
...
- "/" → "ForagePro"
- "/login" → "Sign In | ForagePro"
- "/signup" → "Sign Up | ForagePro"
- "/dashboard" → "Dashboard | ForagePro"
