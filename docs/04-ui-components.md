...
**Product:** ForagePro
**Design Style:** Earthly Delight
**Mode:** light
**Border Radius:** 0.5
**Primary Color:** #6366f1
**Design Description:** The design should evoke a sense of natural wonder, with earthy tones and organic shapes that resemble the wilderness. The layout should be intuitive and easy to navigate, with ample use of white space to create a sense of breathability. The overall atmosphere should be inviting and community-driven, with a focus on showcasing the beauty of wild foods and the people who forage them.
